            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if (task.isSuccessful()){
                    ...
                    try{
                        ...
                        erroExcecao = "Digite uma senha mais forte, contendo mais caracteres, letra e números!";

                    } catch (FirebaseAuthInvalidCredentialsException e) {
                        erroExcecao = "E-mail inválido, digite um e-mail válido!";
                    } catch (FirebaseAuthUserCollisionException e) {
                        erroExcecao = "Esse e-mail já existe!";
